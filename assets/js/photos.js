...
(function() {
  var albums, highlightNavBar, loadAlbums, loadPage, loadPageContent;
  ...
  loadAlbums = function() {
    return $.Mustache.load('albumthumbtpl.html', function() {
      return $('#albums_thumbs').mustache('thumbtpl', albums);
    });
  };
